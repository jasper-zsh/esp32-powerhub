...
- IN0: 一个ACS758用于读取总输入电流，值越小电流越大
- IN1: 一个ACS712用于读取CH4的电流
- IN2: 一个ACS712用于读取CH3的电流
- IN3: 一个ACS712用于读取CH2的电流
- IN4: 一个ACS712用于读取CH1的电流
- IN5: 一个ACS712用于读取CH5的电流
- IN6: 一个ACS712用于读取CH6的电流
